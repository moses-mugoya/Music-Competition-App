...
public class JoinCompetitionActivity extends AppCompatActivity {
    Toolbar mToolbar;
    ...
    private String compTitle, statusValue;
    private Query mCompStatusRef;
    ...
    private String mCurrentUserId, song_title;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mToolbar = findViewById(R.id.join_upload_toolbar);
        mToolbar.setTitle("Join Competition");
        ...
        mCompStatusRef = FirebaseDatabase.getInstance().getReference().child("Competitions").orderByChild("status").equalTo("Ongoing");
        mCompStatusRef.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {

                if (dataSnapshot.exists()){
                    for(DataSnapshot snapshot : dataSnapshot.getChildren()){
                        compTitle = (String) snapshot.child("competitionName").getValue();
                        statusValue = (String) snapshot.child("status").getValue();
                    }
                }
            }
    ...
    public void uploadVideo(){
        song_title = mSongTitle.getText().toString().trim();
                    ...
                    public void onComplete(@NonNull Task<Uri> task) {
                        if (task.isSuccessful()){
                            ...
                            mDatabaseUser.addValueEventListener(new ValueEventListener() {
                                @Override
                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                    newVideo.child("CompetitionName").setValue(compTitle);
                                    newVideo.child("CompetitionStatus").setValue(statusValue);
                                    ...
                                    Intent intent = new Intent(JoinCompetitionActivity.this, MainActivity.class);
